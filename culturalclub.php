...
<html lang="en">
  <head>
    ...
    <title>Cultural Club - UR Student Community</title>
  </head>
...
<div style="background-color: #141414; height: 100px; color: white; text-align: center;">
  <h1 style="font-family: Helvetica; padding-top: 20px;">&#128394; Cultural Club</h1>
</div>
...
<!-- FEED-->
  <div style="width: 100%; height: 100%; background-color: #F6F6F6; margin:10px; padding-top: 10px;">
    ...
    <?php
          ...
          $sql = "SELECT * FROM culturalclubuploads ORDER BY  cid DESC";
    ...
    <!--FEED POSTS-->
     <div class="jumbotron" style="background-color: white; color: black;border-bottom:1px solid grey;">
      <h3><strong><a href="culturalclubposts.php?id='.$row["cid"].'" style="text-decoration:none; color:black;color:#4A4A4A;">'.$row["title"].'</a></strong></h3>
    <p>'.$row["date"].'</p>
