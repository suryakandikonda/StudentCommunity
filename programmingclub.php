...
<html lang="en">
  <head>
    ...
    <title>Programming Club - UR Student Community</title>
  </head>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="includes/programmingclubuploadsimages/banner/1.jpg" alt="First slide" width="1200" height="400">
    </div>
    <div class="carousel-item">
       <img class="d-block w-100" src="includes/programmingclubuploadsimages/banner/2.jpg" alt="First slide" width="1200" height="400">
    </div>
    <div class="carousel-item">
       <img class="d-block w-100" src="includes/programmingclubuploadsimages/banner/3.jpg" alt="First slide" width="1200" height="400">
    </div>
  </div>
...
<div style="background-color: #141414; height: 100px; color: white; text-align: center;">
  <h1 style="font-family: Helvetica; padding-top: 20px;">&#128435; Programming Club</h1>
</div>
...
<!-- FEED-->
  <div style="width: 100%; height: 100%; background-color: #F6F6F6; margin:10px; padding-top: 10px;">
    ...
    <?php
          ...
          $sql = "SELECT * FROM programmingclubuploads ORDER BY  cid DESC";
    ...
    <!--FEED POSTS-->
     <div class="jumbotron" style="background-color: white; color: black;border-bottom:1px solid grey;">
      <h3><strong><a href="programmingclubposts.php?id='.$row["cid"].'" style="text-decoration:none; color:black;color:#4A4A4A;">'.$row["title"].'</a></strong></h3>
    <p>&#128197;  '.$row["date"].'</p>
    <p style="font-family: Verdana, Geneva, sans-serif;">'.$contdis.'...<a href="programmingclubposts.php?id='.$row["cid"].'">Read more</a></p>
  </div> '; }
