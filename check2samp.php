...
<html lang="en">
  <head>
    ...
    <title>Usha Rama Student Community - Explore now</title>
  </head>
  <body style="background-image: linear-gradient(to bottom right, white, #e5e5e1);">
...
<div style="margin:0;">
  ...
  <div class="row" style="color: black; padding-top: 120px; ">
    <img src="images/transs.png" width="250px" height="50px" width="50px" style="padding-top: 60px; display: block;
    margin-left: auto;
    margin-right: auto;
    width: 300px; height: 300px;" class="animated zoomIn"><br><br>
  <h1 class="container-fluid animated fadeInLeft" style="text-align: center; font-family: 'Play',sans-serif;">USHA RAMA<br>STUDENT COMMUNITY</h1>
...
<style type="text/css">
    ...
    .yesImportant{
        color: white; text-align: center; background-color: #980a04; margin-top: 80px;  height: 30px; width: 100%; font-family: 'Ubuntu',sans-serif; text-shadow: 2px 1px black; text-decoration: none;color:white;
    }
    .noImportant{
        color: white; text-align: center; background-color: #060698; margin-top: 80px; height: 30px; width: 100%; font-family: 'Ubuntu',sans-serif; text-shadow: 2px 1px black;
    }
  #button{
            color:#f7f7f7;
            font-family: verdana;
   ...
   @keyframes ChangeLetter{
        ...
        50%{content: "Meet like people...";}
        100%{content: "Exlpore now...";}
   }
   .letterchange::after{
