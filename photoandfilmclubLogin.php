...
<html lang="en">
  <head>
    ...
    <title>Photo and Film Club Admin Panel - URS Community</title>
  </head>
  <body class="text-center">

      <?php
        if (isset($_SESSION['u_uid'])) {
          echo "<br><br><h1>Photo and Film Club Admin Panel</h1><br><br><hr>";
          echo "<form action='includes/photoandfilmlogout.inc.php' method='POST'>
      <button type='submit' name='logout'>Log out</button>
    </form><br>";
         echo " <form action='includes/photoandfilmclubuploads.inc.php' method='POST' enctype='multipart/form-data' style='margin:70px;'>
  ...
  <input class='btn btn-primary' type='submit' value='Upload' name='submit'>
          ...
          echo '<form class="form-signin" style="margin: 10px; margin-top: 20px;" action="includes/photoandfilmclublogin.inc.php" method="POST">
      <h1 class="h3 mb-3 font-weight-normal">Photo and Film Club Admin Panel</h1>
