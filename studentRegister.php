...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="Ex: 17NG1A05B0" name="rollno" onkeydown="upperCaseF(this)">
...
<pre style="color: white;">If anything wrong with the registration, write us at : *****</pre>
  <button type="submit" class="btn btn-primary" name="submit">Register</button>
    ...
    <script type="text/javascript">
      ...
      if(x.indexOf("invalid")!=-1){
        alert("Something wrong with the name.. Please try again");
      }
      if(x.indexOf("email")!=-1){
        alert("Please check the email");
      }
      if(x.indexOf("usertaken")!=-1){
        alert("Given Roll No is already registered with us. For any queries, write us at :");
      }
